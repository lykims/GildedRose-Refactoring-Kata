Notes from [@lykims](https://github.com/lykims) :

I forked the project from [emilybache/GildedRose-Refactoring-Kata](https://github.com/emilybache/GildedRose-Refactoring-Kata), and did the refactoring exercise in [Java](Java/src).
